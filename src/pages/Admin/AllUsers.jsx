      ...
      <main className="flex-1 p-8 lg:p-12 overflow-y-auto">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8 border-b border-slate-200 pb-5">
            <h1 className="text-3xl font-bold tracking-tight text-slate-900">All Users</h1>
            <p className="text-slate-500 mt-1 text-sm">Manage and view all registered users, providers, and admins.</p>
          </div>
